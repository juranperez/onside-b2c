        ...
        {sent ? (
          ...
          <>
            ...
            <button
              ...
              className="w-full h-11 rounded-xl bg-fg text-ink-950 font-semibold text-[14px] flex items-center justify-center gap-2.5 hover:opacity-90 transition cursor-pointer"
            >
